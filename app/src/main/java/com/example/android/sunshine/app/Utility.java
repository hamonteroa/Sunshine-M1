...
public class Utility {
    ...
    public static float DEFAULT_LATLON = 0F;
    ...
    public static float getLocationLatitude(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getFloat(context.getString(R.string.pref_location_latitude), DEFAULT_LATLON);
    }

    public static float getLocationLongitude(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getFloat(context.getString(R.string.pref_location_longitude), DEFAULT_LATLON);
    }
    ...
    */
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        Log.v("art", "formatArtUrl: " + formatArtUrl);
    ...
    static public void resetLocationStatus(Context c) {
        ...
        // apply method is used because it will be called from the UI thread
        spe.apply();
    }
